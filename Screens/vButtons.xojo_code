...
#tag Events btLeft
	...
	#tag EndEvent
#tag EndEvents
#tag Events btPrimary
	#tag Event
		Sub Opening()
		  
		  Me.SetRoleXC(ButtonExtensionsXC.UIButtonRole.primary)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btDestructive
	#tag Event
		Sub Opening()
		  
		  Me.SetRoleXC(ButtonExtensionsXC.UIButtonRole.destructive)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag ViewBehavior
