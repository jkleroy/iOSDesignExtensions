#tag Module
Protected Module ControlExtensionsXC_API1
	...
	#tag Method, Flags = &h0
		Sub SetActivityIndicatorViewStyleXC(extends progress As iOSProgressWheel, value As ControlExtensionsXC.UIActivityIndicatorViewStyle)
		  
		  
		  declare sub setActivityIndicatorViewStyle lib "UIKit.framework" selector "setActivityIndicatorViewStyle:" (id as ptr, value as ControlExtensionsXC.UIActivityIndicatorViewStyle)
