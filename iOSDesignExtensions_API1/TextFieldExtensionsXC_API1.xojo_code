#tag Module
Protected Module TextFieldExtensionsXC_API1
	#tag Method, Flags = &h1
	...
	#tag Method, Flags = &h0
		Function GetSelectedRangeXC(Extends area As iOSTextArea) As TextFieldExtensionsXC.NSRangeXC
		  ...
		  Declare Function selectedRange_ Lib "UIKit.framework" selector "selectedRange" (obj_id As ptr) As TextFieldExtensionsXC.NSRangeXC
	...
	#tag Method, Flags = &h0, Description = 5363726F6C6C7320746F207468652070726F76696465642072616E676520706F736974696F6E2E
		Sub ScrollToRangeXC(Extends area As iOSTextArea, range As TextFieldExtensionsXC.NSRangeXC)
		  ...
		  Declare Sub scrollRangeToVisible_ Lib "UIKit.framework" selector "scrollRangeToVisible:" (obj_id As ptr, rng As TextFieldExtensionsXC.NSRangeXC)
	...
	#tag Method, Flags = &h0
		Sub SetAutocapitalizationTypeXC(extends field As iOSTextField, value As TextFieldExtensionsXC.UITextAutocapitalizationType)
		  ...
		  Declare Sub setAutocapitalizationType_ Lib "UIKit.framework" selector "setAutocapitalizationType:" (obj_id As ptr, value As TextFieldExtensionsXC.UITextAutocapitalizationType)
	...
	#tag Method, Flags = &h0
		Sub SetAutocorrectionTypeXC(extends area As iOSTextArea, value As TextFieldExtensionsXC.UITextAutocorrectionType)
		  ...
		  Declare Sub setAutocorrectionType_ Lib "UIKit.framework" selector "setAutocorrectionType:" (obj_id As ptr, value As TextFieldExtensionsXC.UITextAutocorrectionType)
	...
	#tag Method, Flags = &h0
		Sub SetBorderStyleXC(extends field As iOSTextField, style As TextFieldExtensionsXC.UITextFieldBorderStyle)
		  
		  
		  declare sub setBorderStyle lib "UIKit.framework" selector "setBorderStyle:" (obj_id as ptr, st as TextFieldExtensionsXC.UITextFieldBorderStyle)
	...
	#tag Method, Flags = &h0
		Sub SetKeyboardAppearanceXC(extends field As iOSTextField, appearance As TextFieldExtensionsXC.UIKeyboardAppearance)
		  Declare Sub setKeyboardAppearance Lib "UIKit.framework" selector "setKeyboardAppearance:" (id As ptr, value As TextFieldExtensionsXC.UIKeyboardAppearance)
	...
	#tag Method, Flags = &h0
		Sub SetKeyboardTypeXC(extends field As iOSTextField, type As TextFieldExtensionsXC.UIKeyboardType)
		  Declare Sub setKeyboardType Lib "UIKit.framework" selector "setKeyboardType:" (id As ptr, value As TextFieldExtensionsXC.UIKeyboardType)
	...
	#tag Method, Flags = &h0
		Sub SetLeftViewIconXC(extends field as iOSTextField, image As iOSImage, addIndent As Integer = 0)
		  ...
		  declare sub setLeftViewMode lib "UIKit.framework" selector "setLeftViewMode:" (id as ptr, value as TextFieldExtensionsXC.UITextFieldViewMode)
		  setLeftViewMode field.Handle, TextFieldExtensionsXC.UITextFieldViewMode.always
	...
	#tag Method, Flags = &h0
		Sub SetReturnKeyTypeXC(extends field as iOSTextField, value as TextFieldExtensionsXC.UIReturnKeyType)
		  ...
		  Declare Sub setReturnKeyType_ Lib "UIKit.framework" selector "setReturnKeyType:" (obj_id As ptr, value As TextFieldExtensionsXC.UIReturnKeyType)
	...
	#tag Method, Flags = &h0
		Sub SetSelectedRangeXC(Extends area As iOSTextArea, range As TextFieldExtensionsXC.NSRangeXC)
		  ...
		  Declare Sub selectedRange Lib "UIKit.framework" selector "setSelectedRange:" (obj_id As ptr, rng As TextFieldExtensionsXC.NSRangeXC)
