#tag Module
Protected Module ViewExtensionsXC_API1
	...
	#tag Method, Flags = &h0
		Sub PushToShowModalDissolveXC(extends parent As iOSView, v As iOSView, style As ViewExtensionsXC.UIModalPresentationStyle = ViewExtensionsXC.UIModalPresentationStyle.fullscreen, Animate As Boolean = True, callback As iOSBlock = Nil)
		  ...
		  Selector "presentViewController:animated:completion:" _
		  (parentView As Ptr, viewControllerToPresent As Ptr, animated As Boolean, completion As Ptr)
		  Declare Sub modalPresentationStyle_ Lib "UIKit.framework" Selector "setModalPresentationStyle:" (obj_id As Ptr, modalPresentationStyle As ViewExtensionsXC.UIModalPresentationStyle)
		  Declare Sub modalTransitionStyle_ Lib "UIKit.framework" Selector "setModalTransitionStyle:" (obj_id As Ptr, modalTransitionStyle As ViewExtensionsXC.UIModalTransitionStyle)
		  ...
		  modalTransitionStyle_(navController, ViewExtensionsXC.UIModalTransitionStyle.crossDissolve)
	...
	#tag Method, Flags = &h0
		Sub PushToShowModalFlipXC(extends parent As iOSView, v As iOSView, style As ViewExtensionsXC.UIModalPresentationStyle = ViewExtensionsXC.UIModalPresentationStyle.fullscreen, Animate As Boolean = True, callback As iOSBlock = Nil)
		  ...
		  modalPresentationStyle_(navController, style)
		  modalTransitionStyle_(navController, ViewExtensionsXC.UIModalTransitionStyle.flipHorizontal)
	...
	#tag Method, Flags = &h0
		Sub PushToShowModalXC(extends parent As iOSView, v As iOSView, style As ViewExtensionsXC.UIModalPresentationStyle = ViewExtensionsXC.UIModalPresentationStyle.automatic, Animate As Boolean = True, callback As iOSBlock = Nil, fullModal As Boolean = True)
		  Declare Function NSClassFromString Lib "Foundation" (className As CFStringRef) As Ptr
		  ...
		  Selector "presentViewController:animated:completion:" _
		  (parentView As Ptr, viewControllerToPresent As Ptr, animated As Boolean, completion As Ptr)
		  Declare Sub modalPresentationStyle_ Lib "UIKit" selector "setModalPresentationStyle:" (obj_id As ptr, modalPresentationStyle As ViewExtensionsXC.UIModalPresentationStyle)
		  ...
		  if (XojoVersion < 2019.03 or ExtensionsXC.GetiOSVersionXC < 13.0) and style = ViewExtensionsXC.UIModalPresentationStyle.automatic then
		    style = ViewExtensionsXC.UIModalPresentationStyle.formSheet
		  end if
	...
	#tag Method, Flags = &h0, Description = 536574732074686520636F6C6F72206F6620612056696577
		Sub SetAnimationsEnabledXC(extends v As iOSView, value As Boolean)
		  ...
		  Declare Function NSClassFromString Lib "Foundation.framework" (clsName As CFStringRef) As ptr
		  Declare sub setAnimationsEnabled lib "UIKit" selector "setAnimationsEnabled:" (obj as ptr, value as boolean)
	...
	#tag Method, Flags = &h21
		Private Sub SetDisplayMode(Extends scr As iOSSplitView, mode As ViewExtensionsXC.UISplitViewControllerDisplayMode)
		  //Changes the SplitView in portrait mode
		  
		  Declare Sub setPreferredDisplayMode Lib "UIKit" _
		  selector "setPreferredDisplayMode:" (obj As Ptr, mode As ViewExtensionsXC.UISplitViewControllerDisplayMode)
	...
	#tag Method, Flags = &h0, Description = 5365747320746865204E617669676174696F6E2062617220636F6C6F722E20536574204461726B20746F205472756520696620796F752077616E74207468652074696D6520616E64207374617475732062617220746F206265207768697465
		Sub SetNavBarColorXC(extends v As iOSView, barColor As color, buttonColor As color, titleColor As Color, translucent As boolean = false, Dark As Boolean = False)
		  ...
		  if ExtensionsXC.GetiOSVersionXC >= 13 then
		    ...
		    Declare sub setBackgroundColor lib "UIKit" selector "setBackgroundColor:" (obj as ptr, UIColor as ptr)
		    ...
		    Dim constStr As Text = ExtensionsXC_API1.StringConstantXC("UIKit", "NSForegroundColorAttributeName")
	...
	#tag Method, Flags = &h0, Description = 5365747320746865204E617669676174696F6E2062617220636F6C6F722E20536574204461726B20746F205472756520696620796F752077616E74207468652074696D6520616E64207374617475732062617220746F206265207768697465
		Sub SetNavBarTintColorXC(extends v As iOSView, tintColor As Color)
		  //New in version 2.0
	...
	#tag Method, Flags = &h0
		Sub SetNavBarTranslucentXC(extends v As iOSView, value As Boolean)
	...
	#tag Method, Flags = &h0
		Sub SetNavBarTransparentXC(extends v as iOSView)
		  ...
		  if ExtensionsXC.GetiOSVersionXC >= 13 then
		    ...
		    declare sub configureWithTransparentBackground lib "UIKit" selector "configureWithTransparentBackground" (obj as ptr)
	...
	#tag Method, Flags = &h0, Description = 5365747320746865204E617669676174696F6E2062617220636F6C6F722E20536574204461726B20746F205472756520696620796F752077616E74207468652074696D6520616E64207374617475732062617220746F206265207768697465
		Sub SetStatusBarStyleXC(extends v As iOSView, style As AppExtensionsXC.UIStatusBarStyle)
		  #Pragma Unused v
